            ...
            <div className="text-[12px] flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                    <div className="flex gap-2 min-[850px]:w-full min-[850px]:justify-center">
                        ...
                        <div className="flex flex-col gap-2 w-full relative min-[850px]:hidden" data-aos="fade-left">
                            <img src="/images/star pu2.png" alt="" className="absolute left-4 -top-5 z-20"/>
                    ...
                    <div className="flex gap-2 items-center w-full min-[850px]:justify-between">
                        <div className="flex flex-col gap-2  relative w-2/5 max-[850px]:hidden" data-aos="fade-right">
                            <img src="/images/star pu2.png" alt="" className="absolute left-4 -top-5 z-20 animate-pulse"/>
                            <h3 className="text-[12px] sm:text-[24px] sm:text-[24px] font-bold text-[#D434FE]">Hackathon Announcement</h3>
                            <p className="sm:text-[16px]">The getlinked tech hackathon 1.0 is formally announced to the general public and teams begin to get ready to register</p>
                        </div>
                        ...
                        <p className="text-[12px] sm:text-[24px] font-bold text-[#D434FE] min-[850px]:w-2/5" data-aos="fade-left">November 18, 2023</p>
                    </div>
                </div>
                <div className="flex flex-col gap-2">
                    <div className="flex gap-2 min-[850px]:w-full min-[850px]:justify-center">
                        ...
                        <div className="flex flex-col gap-2 w-full min-[850px]:hidden" data-aos="fade-left">
                    ...
                    <div className="flex gap-2 items-center w-full min-[850px]:justify-between">
                        ...
                        <p className="text-[12px] sm:text-[24px] font-bold text-[#D434FE] min-[850px]:w-2/5" data-aos="fade-right">November 18, 2023</p>
                        ...
                        <div className="flex flex-col gap-2 w-2/5 max-[850px]:hidden" data-aos="fade-left">
                            <h3 className="text-[12px] sm:text-[24px] font-bold text-[#D434FE]">Teams Registration begins</h3>
                            <p className="sm:text-[16px]">Interested teams can now show their interest in the getlinked tech hackathon 1.0 2023 by proceeding to register</p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2 relative items-center w-full min-[850px]:justify-between">
                        <div className="flex flex-col gap-2 w-2/5 max-[850px]:hidden" data-aos="fade-right">
                            <h3 className="text-[12px] sm:text-[24px] font-bold text-[#D434FE]">Teams Registration ends</h3>
                            <p className="sm:text-[16px]">Interested Participants are no longer Allowed to register </p>
                        </div>
                        ...
                        <p className="text-[12px] sm:text-[24px] font-bold text-[#D434FE] min-[850px]:w-2/5" data-aos="fade-left">November 18, 2023</p>
                        <img src="/images/star2.png" alt="" className="absolute -bottom-1 right-16 z-20 w-2 animate-pulse"/>
                    </div>
                </div>
                <div className="flex flex-col gap-2">
                    <div className="flex gap-2 min-[850px]:w-full min-[850px]:justify-center">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2 relative items-center w-full min-[850px]:justify-between">
                        ...
                        <img src="/images/star-grey2.png" alt="" className="absolute -left-4 top-10  z-20 w-3 animate-pulse"/>
                    </div>
                </div>
            </div>
        </div>
